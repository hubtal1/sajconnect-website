  ...
  return (
    ...
    >
      {isDark ? (
        ...
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" class="text-[var(--color-text-on-carbon-muted)] transition-colors group-hover:text-[var(--color-cobalt-light)]">
        ...
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" class="text-[var(--color-text-on-carbon-muted)] transition-colors group-hover:text-[var(--color-cobalt-light)]">
